"""
Uses pre-trained yolo model to determine pose in a video. This one is in ROS and gives you a frame by frame, so you
don't need to preprocess the whole video.
